...
- `AGENTS.md` — source-repo developer guidance only; not installed as framework-home guidance
...
**Templates:**
- `AGENTS.template.md` — project root bootstrap; points tools and agents to the Crux coordinator skill
...
{project}/AGENTS.md          project bootstrap; points agents to crux-coordinator
